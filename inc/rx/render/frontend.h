...
struct frontend {
  frontend(memory::allocator* _allocator, rx_size _command_memory);
  ~frontend();
...
private:
  ...
  rx::concurrency::mutex m_mutex;

  rx::memory::pool_allocator m_buffer_pool;    // protected by |m_mutex|
  rx::memory::pool_allocator m_target_pool;    // protected by |m_mutex|
  rx::memory::pool_allocator m_texture1D_pool; // protected by |m_mutex|
  rx::memory::pool_allocator m_texture2D_pool; // protected by |m_mutex|
  rx::memory::pool_allocator m_texture3D_pool; // protected by |m_mutex|
  rx::memory::pool_allocator m_textureCM_pool; // protected by |m_mutex|

  rx::array<buffer*> m_destroy_buffers;        // protected by |m_mutex|
  rx::array<target*> m_destroy_targets;        // protected by |m_mutex|
  rx::array<texture1D*> m_destroy_textures1D;  // protected by |m_mutex|
  rx::array<texture2D*> m_destroy_textures2D;  // protected by |m_mutex|
  rx::array<texture3D*> m_destroy_textures3D;  // protected by |m_mutex|
  rx::array<textureCM*> m_destroy_texturesCM;  // protected by |m_mutex|

  rx::array<rx_byte*> m_commands;              // protected by |m_mutex|
