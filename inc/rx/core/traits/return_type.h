...
namespace detail {
  ...
  struct return_type<R (Ts...)> : type_identity<R> {};
  template<typename R, typename... Ts>
  struct return_type<R (*)(Ts...)> : type_identity<R> {};
  template<typename T, typename R, typename... Ts>
  struct return_type<R (T::*)(Ts...)> : type_identity<R> {};
  template<typename T, typename R, typename... Ts>
  struct return_type<R (T::*)(Ts...) const> : type_identity<R> {};
  template<typename T, typename R, typename... Ts>
  struct return_type<R (T::*)(Ts...) volatile> : type_identity<R> {};
  template<typename T, typename R, typename... Ts>
  struct return_type<R (T::*)(Ts...) const volatile> : type_identity<R> {};
  template<typename T, typename R, typename... Ts>
  struct return_type<R (T::*)(Ts...) &> : type_identity<R> {};
  template<typename T, typename R, typename... Ts>
  struct return_type<R (T::*)(Ts...) &&> : type_identity<R> {};
